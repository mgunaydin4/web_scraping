...
# Online kitap satışı yapan bir şirket, “Seyahat” ve “Kurgu Dışı” kategorilerinde az satış yaptığını tespit
# ediyor. Bu sebeple şirketin, rakip firmanın kazınması izin verilen https://books.toscrape.com/ adlı web
# sitesinden “Travel” ve “Nonfiction” kategorisindeki kitaplara ait bilgileri alıp rakip ve fiyat analizi
# yapmaya ihtiyacı var. Şirket sizden, bu kategorilerdeki her bir kitaba ait detay sayfalarına gitmenizi ve
# orada bulunan bazı bilgileri almanızı bekliyor.
